...
const Organization = () => {
    ...
    const handleLeave = async () => {
        ...
        try {
            const res = await Axios.post(`/organization/leave`, { org_id: leaveId }, authorizationHeaders());
    ...
    return (
        <>
            ...
            <Leave show={show.leaveModal} handleClose={handleClose} handleLeave={handleLeave} isLeaveLoading={isLeaveLoading} role={"organization"} />

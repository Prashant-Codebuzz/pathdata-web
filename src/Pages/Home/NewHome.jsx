            ...
            <div className='mt-4 pd'>
                ...
                <div className='digital-ecosystem'>
                    ...
                    <div className='row mt-4'>
                        ...
                        <div className='col-lg-3 mb-4 mb-lg-5'>
                            <div className="home-card-view" onClick={() => navigate("/invitation")}>
                                <div className="d-flex flex-column justify-content-between">
                                    <img src={billing} alt="" height={50} width={50} className='mb-3' />
                                    <div>
                                        <span className="digital-title">Pending Invites</span>
                                        <p className="digital-desc">View pending invites, and manage your invitations.</p>
                                    </div>
                                </div>
                            </div>
                        </div>

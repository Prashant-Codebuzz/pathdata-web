                ...
                <div className='home-main-view'>
                    <div className="row text-center">
                        <div className="col-lg-4 col-md-12 welcome-box">
                            <span className='welcome-title'>Welcome to {familyName || ""}</span>
                        ...
                        <div className="col-lg-8 col-md-12 welcome-card justify-content-end">
                            <div className="row g-3">
                                <div className='col-lg-4 col-md-6 col-sm-12'>
                                    <div className='card-one cursor-pointer' onClick={() => navigate("/vpc")} >
                                        ...
                                        <div className='card-tecnical'>
                                            ...
                                            <span className='tec-description'>Deploy the Pathsdata cluster to your account using cross-account access. This setup requires configuring VPC, subnets, EC2 instances, and IAM profiles in your account to ensure a secure and scalable cluster environment. These resources will also be set up in the Pathsdata account for proper integration and functionality.</span>
                                        </div>
                                    </div>
                                </div>
                                <div className='col-lg-4 col-md-6 col-sm-12'>
                                    <div className='card-two cursor-pointer' onClick={() => navigate("/cluster")} >
                                        <div className='card-main'>
                                            <div>
                                        ...
                                        <div className='card-tecnical'>
                                            ...
                                            <span className='tec-description'>Create and manage clusters to organize resources and tasks more efficiently, ensuring a streamlined and scalable environment.</span>
                                        </div>
                                    </div>
                                </div>
                                <div className='col-lg-4 col-md-6 col-sm-12'>
                                    <div className='card-three cursor-pointer' onClick={() => navigate("/data-catalog")}>
                                        <div className='card-main'>
                                            <div>
                                        ...
                                        <div className='card-tecnical'>
                                            ...
                                            <span className='tec-description'>Connect and configure your data sources for seamless integration. Easily store and access family data, ensuring consistency and security.</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div className='digital-ecosystem'>
                    <div className="row align-items-center justify-content-between">
                        ...
                        <div className='col-lg-6 mt-4 mb-4 d-lg-flex justify-content-lg-end'>
                            <button className="back-home-btn boreder-0" type="button" onClick={BackToMainHome}>
                                Back to Main Home
                            </button>
                        </div>
                    </div>
                    ...
                    <div className='row mt-4'>
                        <div className={`${openUser === false ? 'col-lg-4' : 'col-lg-3'} mb-4 mb-lg-5`}>
                            <div className="home-card-view" onClick={() => navigate("/data-catalog")}>
                                <div className="d-flex flex-column justify-content-between">
                                    <img src={catelogbtn} alt="" height={50} width={50} className='mb-3' />
                                    <div>
                                        <span className="digital-title">
                                            Data Source
                                        </span>
                                        <p className="digital-desc">Explore and manage your available products. </p>
                                    </div>
                                </div>
                            </div>
                        </div>
...

                        {
                            FamilyId ? '' : (
                                <div className={`${openUser === false ? 'col-lg-4' : 'col-lg-3'} mb-4 mb-lg-5`}>
                                    <div className="home-card-view" onClick={() => navigate("/user-management")}>
                                        <div className="d-flex flex-column justify-content-between">
                                            <img src={Userbtn} alt="" height={50} width={50} className='mb-3' />
                                            <div>
                        ...
                        <div className={`${openUser === false ? 'col-lg-4' : 'col-lg-3'} mb-4 mb-lg-5`}>
                            <div className="home-card-view">
                                <div className="d-flex flex-column justify-content-between">
                                    <img src={Cloudservicesbtn} alt="" height={50} width={50} className='mb-3' />
                                    <div>
                                        <span className="digital-title"> Cloud Services</span>
                                        <p className="digital-desc">Monitor and configure your cloud-based resources. </p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div className={`${openUser === false ? 'col-lg-4' : 'col-lg-3'} mb-4 mb-lg-5`}>
                            <div className="home-card-view" onClick={() => navigate("/setting")}>
                                <div className="d-flex flex-column justify-content-between">
                                    <img src={Settinghomebtn} alt="" height={50} width={50} className='mb-3' />
                                    <div>

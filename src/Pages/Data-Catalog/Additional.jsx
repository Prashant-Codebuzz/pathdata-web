...
import additionalicon from "../../assets/images/additional.png";
                        ...
                        <div className="col-lg-6 mb-3 ">
                            <div className=''>
                                <div className="data-source-view ">
                                    <img src={additionalicon} alt="" height={65} className="mb-4" />
                                    <p className="data-source-title">Additional</p>
                                </div>
                            </div>
                        </div>
                        <div className="col-lg-6 mb-3 mt-5">
                            <div className="col-lg-12 mb-3">
                                <label htmlFor="role" className="form-label">Type of Category</label>

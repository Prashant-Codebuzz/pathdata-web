...
const Header = ({ mobileToggle, setMobileToggle, handleLogout }) => {
    ...
    useEffect(() => {
        ...
        else if (pathname === "/cluster" || pathname === "/add-cluster" || pathname === "/edit-cluster" || pathname.startsWith("/cluster-details")) {
            name = "Cluster";
        }
        ...
        else if (pathname === "/user-management" || pathname === "/add-member" || pathname === "/role") {

...
const initialState = {
    ...
    ebs_size: "", // EBS Size
    instance_profile_arn: "", // Master Node Profile 
    worker_details: {
        instance_type: "", // Work Node Type
        instance_profile_arn: "", // Work Node Profile
...
const AddCluster = () => {
    ...
    console.log("selectedNetworkList", selectedNetworkList);
    console.log("selectedNetworkList?.subnet_ids", selectedNetworkList?.subnet_ids);
    ...
    const handleSubmit = async (e) => {
        ...
        const payload = {
            ...
            instance_profile_arn: formData.instance_profile_arn,
            tags: [{
                Key: "CreatedBy",
                Value: "Nithya"
            }]
        ...
        if (formData.cluster_type === "distributed") {
            payload.worker_details = {
                ...
                instance_profile_arn: formData.worker_details?.instance_profile_arn,
    ...
    const GetRunTime = async () => {
        try {
            const res = await Axios.get(`/metadata/runtime_versions`, authorizationHeaders());

            if (res.data?.statusCode === 200) {
                setRuntimeList(res.data.data);
            }
            else {
                toast.error(res.data?.message);
            }
                                    ...
                                    <div className="col-lg-6 mb-4 ">
                                        ...
                                        <div className="add-input">
                                            ...
                                            >
                                                ...
                                                {
                                                    selectedNetworkList?.subnet_ids?.length > 0 ? (
                    ...
                    <section className='add-content-section mb-5'>
                        ...
                        <div className="second mt-3 mt-lg-4">
                            <div className="row mt-4">
                                ...
                                <div className="col-lg-6 mb-4 ">
                                    <label htmlFor="instance_profile_arn" className="form-label">Master Node Profile</label>
                                                ...
                                                <div className="add-input">
                                                    ...
                                                    >
                                                        ...
                                                        {resourcesIAMList?.map((i, index) => (
                                                            <option key={index} value={i.instance_profile_arn}>
                                ...
                                <section className='add-content-section '>
                                    ...
                                    <div className="second mt-3 mt-lg-4">
                                        <div className="row mt-4">
                                            ...
                                            <div className="col-lg-6 mb-4 ">
                                                <label htmlFor="instance_profile_arn" className="form-label">Work Node Profile</label>
                                                {
                                                    resourcesIAMList?.length > 0 ? (
                                                        <>
                                                            <div className="add-input">

                    ...
                    <nav className="menu open-current-submenu">
                        <ul>
                            <li className="menu-item">
                                <NavLink
                                    // to="/home"
                                    to={((openClodeOption === true) || (openClodeOption === false && openUser === true)) ? "/home2" : "/home"}
                            ...
                            {/* {openClodeOption === false && !UserOrgId && */}
                            {/* {((openClodeOption === false) || (openClodeOption === false && openUser === false)) &&
                                <>
                                    <li className="menu-item">
                                        <NavLink
                                            to="/organization"
                                ...
                                <>
                                    ...
                                    <li className="menu-item">
                                        <NavLink
                                            to="/query-history"
                                            className={`menu-link d-flex align-items-center 
                                                ${pathname === "/query-execution" || pathname.startsWith("/query-runner") ? "active" : ""}
                                            `}
                                            onClick={handleSidebarDismiss}
                                        >
                                            <span className="menu-icon">
                                                <img src={queryinterface} alt="" />
                                            </span>
                                            <span className="menu-title" onClick={() => toggleMenu("query-history")}>Query Interface</span>
                                        </NavLink>
                                    </li>
                                        ...
                                        <NavLink
                                            ...
                                            className={`menu-link d-flex align-items-center 
                                                ${pathname === "/add-cluster" ||
                                                    pathname.startsWith("/cluster-details")
                                                    ? "active" : ""}
                                            `}
                                            onClick={handleSidebarDismiss}
                                        >
                            ...
                            <li className="menu-item">
                                <NavLink
                                    to="/ai-chat"
                                    className={`menu-link d-flex align-items-center ${pathname === "/ai-chat" ? "active" : ""}`}
                                    onClick={handleSidebarDismiss}
                                >
                                    <span className="menu-icon">

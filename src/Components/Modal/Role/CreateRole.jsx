...
const CreateRole = ({ show, handleClose, GetRoleList }) => {
    ...
    console.log(JSON.stringify(formData?.permissions));
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            console.error("Error Post Role++", err);
            ...
            <div className="modal-body mt-3">
                <div className="content text-center">
                    ...
                    <p className='mt-3 mt-lg-4'>
                        Set up a new user role by giving it a name, a short
